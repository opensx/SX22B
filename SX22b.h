 ...
 *
 *  Changed on: 09.05.2015 by Reinhard Thamm, referring to comments
 *  Version:    2.2b
 *  Minor changes in .cpp file led to this newer version;
 *  No changes carried out here...
 *  
 *  24.09.2015: some cosmetic changes.
 *  
...
#define SX_DATA         4
#define SX_DATA_DDR     DDRD                        //Tha: for faster direct bitwise operations
#define SX_DATA_PORT    PORTD                       //Tha
#define SX_DATA_PORTPIN PORTD4                      //Tha
...
#define SX_OUT_DDR      DDRD                        //Tha: for faster direct bitwise operations
#define SX_OUT_PORT     PORTD                       //Tha
#define SX_OUT_PORTPIN  PORTD6                      //Tha
